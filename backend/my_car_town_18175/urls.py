"""my_car_town_18175 URL Configuration
...
admin.site.site_header = "My car town"
admin.site.site_title = "My car town Admin Portal"
admin.site.index_title = "My car town Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="My car town API",
        default_version="v1",
        description="API documentation for My car town App",
    ),
    public=True,
